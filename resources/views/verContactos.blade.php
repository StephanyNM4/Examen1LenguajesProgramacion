                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <p>
                                        <a href="{{ route( 'contacto.create', $directorio->codigoEntrada) }}" class="btn btn-primary">Agregar nuevo contacto</a>
                                        ...
                                        <tbody>
                                            @foreach ($contactos as $item)
                                                <tr>
                                                    ...
                                                    <td>{{$item->correo}}</td>                                                     
                                                    <td>
                                                        <a href="{{ route( 'contacto.destroy', $item->id) }}" class="btn btn-danger">Eliminar</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
